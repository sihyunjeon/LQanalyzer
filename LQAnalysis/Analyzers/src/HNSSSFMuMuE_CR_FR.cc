...
//    if( !(electronPromptColl.size() == 2) ) electronNonpromptColl = GetHNElectronsByLooseRelIso(0.5, true);
  ...
  if((is_mumue)){
    ...
    weight = m_datadriven_bkg->Get_DataDrivenWeight(false, muonLooseColl, "MUON_HN_TRI_TIGHT", 1, electronLooseColl, "ELECTRON16_HN_TIGHT", 1);
    weight_err = m_datadriven_bkg->Get_DataDrivenWeight(true, muonLooseColl, "MUON_HN_TRI_TIGHT", 1, electronLooseColl, "ELECTRON16_HN_TIGHT", 1);
  }
