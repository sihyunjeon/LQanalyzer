#ifndef CFRateCalculator_FR_syst_h
#define CFRateCalculator_FR_syst_h

#include "AnalyzerCore.h"
class CFRateCalculator_FR_syst : public AnalyzerCore {

 public:
  //// constructors                                                                                                                                                             
  CFRateCalculator_FR_syst();
  ~CFRateCalculator_FR_syst();
 ...
 private:
  ...
  ClassDef ( CFRateCalculator_FR_syst, 1);
};
#endif
