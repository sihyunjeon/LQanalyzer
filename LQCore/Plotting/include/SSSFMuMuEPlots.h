#ifndef SSSFMuMuEPlots_h
#define SSSFMuMuEPlots_h
...
class SSSFMuMuEPlots : public StdPlots{
 ...
 public:
  ...
  /// copy constructor
  SSSFMuMuEPlots(const SSSFMuMuEPlots& sp);  ///Copy constructor
  /// assigment operator
  SSSFMuMuEPlots& operator=(const SSSFMuMuEPlots& obj);
